...
// Route::get('/procurement', [App\Http\Controllers\ProcurementController::class, 'data'])->name('procurement');
Route::get('/procurement', [ProcurementController::class])->name('procurement');
Route::resource('procurement', ProcurementController::class);
Route::get('getprocurement', [ProcurementController::class, 'getData'])->name('procurement.getData');
